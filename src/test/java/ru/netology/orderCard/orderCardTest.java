...
public class orderCardTest {
    ...
    void shouldFillForm() {
        ...
        String
                actual =
                driver.findElement( By.cssSelector( ".paragraph" ) ).getText().trim();
        assertEquals( expected, actual );
    }

    @Test
    void shouldFillNameWrong() {
        driver.findElement( By.cssSelector( "[data-test-id=name] .input__control" ) ).sendKeys( "Test" );
        driver.findElement( By.cssSelector( "[data-test-id=phone] .input__control" ) ).sendKeys( "+79653560606" );
        driver.findElement( By.cssSelector( ".checkbox__box" ) ).click();
        driver.findElement( By.cssSelector( "button" ) ).click();
        String
    ...
    void shouldNotCheckBox() {
        ...
        String
                actual =
                driver.findElement( By.cssSelector( "[role='presentation']" ) ).getText().trim();
        assertEquals( expected, actual );
